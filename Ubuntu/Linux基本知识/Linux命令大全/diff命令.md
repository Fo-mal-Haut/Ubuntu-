**资料参考**：[linux diff命令](https://www.runoob.com/linux/linux-comm-diff.html)
...
以下`less`输出发生在Ubuntu升级到24.04过程，`diff` 生成差异，`less` （[终端分页查看器](终端分页查看器.md)）负责显示输出
```Bash
*** fwupd.conf (Y/I/N/O/D/Z) [默认选项=N] ? D
--- /etc/fwupd/fwupd.conf       2026-01-13 11:46:14.746928336 +0800
+++ /etc/fwupd/fwupd.conf.dpkg-new      2025-07-10 23:14:30.000000000 +0800
@@ -1,35 +1,2 @@
-[msr]
-#
